...
<table>
    ...
    <asp:PlaceHolder runat="server" ID="plcNewSite">
        <tr>
            ...
            <td>
                <cms:LocalizableTextBox CssClass="TextBoxField" ID="txtSiteDisplayName" runat="server"
                    MaxLength="200" />
                &nbsp;
        ...
        <tr>
            ...
            <td>
                <cms:CodeName ID="txtSiteName" runat="server" MaxLength="100" CssClass="TextBoxField" />
            </td>
        </tr>
        <tr>
            <td>
