    ...
    public TreeNode SelectedNode
    {
        get
        {
            if (mSelectedNode == null)
            {
                ...
                if ((mSelectedNode == null) || (!String.IsNullOrEmpty(CurrentUser.UserStartingAliasPath) && !mSelectedNode.NodeAliasPath.StartsWithCSafe(CurrentUser.UserStartingAliasPath, true)))
                {
