...
public partial class CMSModules_DocumentTypes_Pages_Development_DocumentType_List : SiteManagerPage
{
    ...
    protected void uniGrid_OnAction(string actionName, object actionArgument)
    {
        ...
        else if (actionName == "delete")
        {
            ...
            {
                // Check default class
                if (dci.ClassName.EqualsCSafe(DataClassInfoProvider.DefaultPageClassName, true))
                {
                    ShowError(String.Format(GetString("DocumentType_List.DefaultPageClass"), dci.ClassName));
                }
                // Check inerasable dependences
                else if (DataClassInfoProvider.CheckDependencies(dci.ClassID))
                {
