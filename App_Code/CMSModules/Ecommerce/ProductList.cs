...
public class ProductList : System.Web.Services.WebService
{
    ...
    public string GetCategories()
    {
        ...
        DataSet ds = TreeHelper.GetDocuments(CMSContext.CurrentSiteName, "/Products/%", TreeProvider.ALL_CULTURES, false, DataClassInfoProvider.DefaultPageClassName, "", "DocumentName", 1, true, -1);
